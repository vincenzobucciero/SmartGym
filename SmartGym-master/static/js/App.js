...
function createWorkoutPage() {
  ...
  for(var i = 0; i < resultsPage.length; i++){
    ...
    vidContainer.setAttribute('class', 'col-md-4 col-sm-6 col-xs-12');
    var boxContainer = document.createElement('div');
    boxContainer.setAttribute('class', 'ctc-box tv-section-title');
    boxContainer.setAttribute('id', workoutId[i]);
    var video = document.createElement('iframe');
    video.setAttribute('class', 'iframeSizing');
    video.src = resultsPage[i].img;
    vidContainer.appendChild(boxContainer);
    workoutContainer.appendChild(vidContainer);
    boxContainer.appendChild(video);
  }
  for(var i = 0; i < resultsPage.length; i++){
    ...
    var iframeDesc = document.createElement('h4');
...
function bringName() {
  ...
  var appendName = document.createElement('h3');
  if (user){
    appendName.innerText = 'Hey let\'s get this workout started!';
  }else {
